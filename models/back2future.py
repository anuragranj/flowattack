...
class Back2Future(nn.Module):
    ...
    def initialize(self):
        ...
        map = {'conv1a': '3', 'conv1b': '6', 'conv1c': '22',
        'conv2a': '4', 'conv2b': '7', 'conv2c': '23',
        'conv3a': '9', 'conv3b': '10', 'conv3c': '24',
        'conv4a': '12', 'conv4b': '13', 'conv4c': '25',
        'conv5a': '15', 'conv5b': '16', 'conv5c': '26',
        'conv6a': '18', 'conv6b': '19', 'conv6c': '27',
        'decoder_fwd6': '30', 'decoder_bwd6': '93', 'decoder_occ6': '183',
        'decoder_fwd5': '45', 'decoder_bwd5': '96', 'decoder_occ5': '164',
        'decoder_fwd4': '60', 'decoder_bwd4': '99', 'decoder_occ4': '145',
        'decoder_fwd3': '75', 'decoder_bwd3': '102', 'decoder_occ3': '126',
        'decoder_fwd2': '90', 'decoder_bwd2': '105', 'decoder_occ2': '109'
         }
    ...
    def forward(self, im_past, im_tar, im_future):
        '''
            Arguments:
                im_tar : Centre Frame
                im_refs : List constaining [Past_Frame, Future_Frame]
        '''
        im_past = self.normalize(im_past)
        im_tar = self.normalize(im_tar)
        im_future = self.normalize(im_future)
